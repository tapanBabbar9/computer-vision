    ...
    for idx, meta in enumerate(filtered_metadata):
        ...
        with cols[col_idx]:
            ...
            if os.path.exists(img_path):
                ...
                st.image(img_rgb, caption=f"Face {idx}", use_container_width=True)
            ...
            if distance < distance_thresh: 
                ...
                if matched_metadata:
                    ...
                    if os.path.exists(img_path_full):
                        ...
                        with cols[0]:
                            #st.image(cropped_img_rgb, caption=f"Cropped Face (Distance: {distance:.4f})", use_container_width=True)
                            st.image(cropped_img_rgb, use_container_width=True)
